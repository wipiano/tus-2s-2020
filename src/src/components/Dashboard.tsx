            ...
            <Grid item xs={12}>
                <Paper className={classes.paper}>
                    ...
                    <Typography variant="body1">
                        新型コロナウイルスの影響により，東京理科大学の授業日程等に関する情報が散逸しています．
                        ...
                        情報提供や改善の提案は <OuterLink href="https://docs.google.com/forms/d/1LwwUYLwPktWRQDjhVva-1r8abPOQnuBFBb3e_b2quVk">情報提供フォーム</OuterLink>または，
            ...
            <Grid item xs={12}>
                <Paper className={classes.paper}>
                    ...
                    <List>
                        ...
                        <ListItem>
                            <ListItemText>
                                <a href="/syllabus">履修について</a> (2020.04.10)
                            </ListItemText>
                        </ListItem>
                    </List>
                </Paper>
            ...
            <Grid item xs={12}>
                <Paper className={classes.paper}>
                    ...
                    <Typography variant="body1">
                        ...
                        (<OuterLink href="https://www.tus.ac.jp/today/20200409_3256.pdf">窓口の取り扱いについて</OuterLink>)
                    </Typography>
                </Paper>
            </Grid>
            <Grid item xs={12}>
